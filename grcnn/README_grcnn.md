...
python train_network.py --dataset jacquard --dataset-path '/home/robot/vision_servo/demo0122/Jacquard' --description training_jacquard --use-dropout 0 --input-size 300
